...
(function ($) {
    ...
    Editable.prototype = {
        ...
        send: function(value) {
            ...
            if (send) { //send to server
                ...
                this.settings.parameters = tryParseJson(this.settings.parameters, true);

                //creating parameters
                parameters = (typeof this.settings.parameters === 'string') ? {parameters:this.settings.parameters} : $.extend({}, this.settings.parameters);
    ...
    $.fn.editable.defaults = {
        ...
        parameters:null, //additional parameters to submit
